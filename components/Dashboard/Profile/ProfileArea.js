              ...
              <div className='row'>
                <div className='col-lg-12 col-md-12'>
                  <div className='form-group profile-box'>
                    {updateUser.avatar ? (
                      <img src={mediaPreview?mediaPreview:updateUser.avatar} alt='image' />
                    ) : (
                      <img src='https://res.cloudinary.com/dfmn9nhqt/image/upload/v1631086593/img_avatar_srymke.png' alt='avatar'/>
                    )}
